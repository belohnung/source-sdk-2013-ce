...
ConVar	sk_plr_max_dmg_uranium	("sk_plr_max_dmg_uranium", "0", FCVAR_REPLICATED);
ConVar	sk_npc_max_dmg_uranium	("sk_npc_max_dmg_uranium", "0", FCVAR_REPLICATED);

ConVar	sk_max_uranium_round	("sk_max_uranium_round", "0", FCVAR_REPLICATED);
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("Uranium",			DMG_SHOCK,					TRACER_NONE,			"sk_plr_dmg_uranium",		"sk_npc_dmg_uranium",		"sk_max_uranium_round", BULLET_IMPULSE(650, 8000), 0 ); // hit like a 10kg weight at 400 in/s
