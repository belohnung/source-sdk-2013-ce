...
{
	{ ACT_IDLE,				ACT_IDLE_SMG1,			true },		// FIXME: hook to Gauss unique
	{ ACT_IDLE_ANGRY,		ACT_IDLE_ANGRY_SMG1,	true },		// FIXME: hook to Gauss unique

	{ ACT_WALK,				ACT_WALK_RIFLE,			true },
	{ ACT_RUN,				ACT_RUN_RIFLE,			true },

	{ ACT_RANGE_ATTACK1,	ACT_RANGE_ATTACK_AR2,	true },
	{ ACT_RANGE_ATTACK2,	ACT_GAUSS_SPINUP,		true },
	{ ACT_VM_PULLBACK,		ACT_GAUSS_SPINCYCLE,	true },
};
...
extern ConVar sk_plr_dmg_uranium;
extern ConVar sk_npc_dmg_uranium;
extern ConVar sk_plr_max_dmg_uranium;
extern ConVar sk_npc_max_dmg_uranium;
extern ConVar sk_max_uranium_round;
...
void CWeaponGaussGun::Fire( void )
{
	...
	CTakeDamageInfo dmgInfo( this, pOwner, sk_plr_dmg_uranium.GetFloat(), DMG_SHOCK );
...
void CWeaponGaussGun::ChargedFire( void )
{
	...
	float flDamage = sk_plr_dmg_uranium.GetFloat() + ( ( sk_plr_max_dmg_uranium.GetFloat() - sk_plr_dmg_uranium.GetFloat() ) * flChargeAmount );
